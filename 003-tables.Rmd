...
datatable(iris)
dstPath <- file.path(getwd(), "tables")
```
...
listOfCaptions <- list('Table 1' = "This table represents a linear model fitted with all data available to identify which covariates influence the calculation of BCUI results",
