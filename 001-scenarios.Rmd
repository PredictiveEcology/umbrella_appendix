...
We developed ten scenarios defined as the area used for the calculation of the caribou umbrella index: from 5% to 95% of the study area excluding water, in 10% increments. With landbirds density on water pixels being equal to zero, we excluded these pixels from BCUI assessment.
